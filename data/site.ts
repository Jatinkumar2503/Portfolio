export const profile = {
  name: "JATIN KUMAR",
  tag: "AI/ML ENGINEER • RESEARCHER • BUILDER",
  headline:
  ...
  metaDescription:
    "Jatin Kumar is a computer science engineer working on AI/ML systems, simulation, optimization, multi-agent systems and technical research.",
